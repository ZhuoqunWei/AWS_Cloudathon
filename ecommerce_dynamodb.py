...
Complete utility for working with Products, Orders and Users tables in DynamoDB
"""
import boto3
import json
import uuid
...
class EcommerceDynamoDB:
    ...
    def create_order(self, user_id, order_items, total_amount):
        """
        Create a new order
        order_items should be a list of dicts with product_id, quantity, price
        """
    ...
    def create_tables_if_not_exist(self):
        ...
        if 'Orders' not in existing_tables:
            ...
            # Wait for table creation
            print("Waiting for Orders table to be created...")
            self._wait_for_table('Orders')
